...
//					Lista<Mesa> baseMesa = BaseDados.getInstance().getBaseMesa();
	...
	private void pedidoTerminado() {
		boolean ehSair = false;
		
		while (!ehSair) {
			visual.pedidoTerminado();
	...
	private void entregarPedido() {
		...
		String opcao = Entrada.getInstance().retornaDado("ENTREGAR PEDIDO [S / n]: ");
	...
	private void cancelarPedido() {
		...
		String opcao = Entrada.getInstance().retornaDado("DESEJA CANCELAR O PEDIDO [S / n]: ");
